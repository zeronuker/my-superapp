...
export default function ScientificCalculator() {
  ...
  return (
    <div className="cp-calc-shell-wide cp-sci-shell">

      {/* display */}
      <div className="cp-sci-area-display" style={{ background: 'var(--cp-bg3)', border: '1px solid var(--cp-border)',
        borderRadius: 6, padding: 'clamp(5px, 2vh, 20px) 18px clamp(6px, 2.4vh, 24px)', textAlign: 'right' }}>
      ...
      <div className="cp-sci-area-controls" style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: CALC_GRID_GAP }}>
      ...
      <div className="cp-sci-area-functions" style={{ display: 'grid', gridTemplateColumns: 'repeat(6, 1fr)', gap: CALC_GRID_GAP }}>
      ...
      {/* numpad */}
      <div className="cp-sci-area-numpad" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: CALC_GRID_GAP }}>
      ...
      <div className="cp-sci-area-equals">
        <Btn style={{ ...BTN.eq, width: '100%' }} onClick={equals} hapticType="heavy">=</Btn>
      </div>
    </div>
  )
}
