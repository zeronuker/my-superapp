...
// `options` (scoped only, required): the two choices, each
// { value, label, desc, danger }. `copy` (scoped only): optional intro line
// shown above them when there's no unsaved-briefing warning to show instead.
