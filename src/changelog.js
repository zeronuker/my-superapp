...
export const CHANGELOG = [
  ...
  },
  {
    ...
    notes: [
      ...
      "FIX: FTL: PIC discretion over the limit (2h before a non-final sector, 3h otherwise) was capped — the extension and actual finish now show what actually happened, and the CAAM report is flagged whenever the real extension is over 2h (Ch. 2.15.1, 2.15.4)",
      "FIX: FTL: discretion beyond 3h now shows an emergency-only warning (Ch. 2.15.1 Note 1) instead of an error",
      "FIX: FTL: a delay after being called out from standby no longer uses the delayed-reporting rule — Delayed Reporting is hidden while Standby is on, and the actual report time goes in REPORT TIME so standby Case A/B applies (Ch. 2.9.3)",
      "FIX: FTL: two non-acclimatised pilots with a sector over 11h are now blocked (Ch. 2.11.1 — an additional pilot is required) instead of showing an unmodified Table B figure",
      "FIX: FTL: REDUCED PRECEDING REST now covers any reduced rest (Ch. 2.14.3, 2.14.4 or 2.16), not only a PIC reduction",
